...
#' Morat, F., Wicquart, J., Schiettekatte, N. M. D., de Synéty, G., Bienvenu, J., Casey, J. M., Brandl, S. J., Vii, J., Carlot, J., Degregori, S., Mercière, A., Fey, P., Galzin, R., Letourneur, Y., Sasal, P., Parravicini, V. Individual back-calculated size-at-age based on otoliths from Pacific coral reef fish species. _Scientific Data_, 7, 370 (2020).
...
#'
#' @references Morat et al. (2020) Individual back-calculated size-at-age based on otoliths from Pacific coral reef fish species. Scientific Data, 7, 370 (2020).
